<img width="1571" height="620" alt="image" src="https://github.com/user-attachments/assets/5ff746eb-7802-46fb-8fde-5e17dfb1c1b9" />Условие: Веб-приложение позволяет пользователю оплатить заказ банковской картой. Оплата происходит через внешний платежный шлюз после нажатия кнопки «Оплатить»:
