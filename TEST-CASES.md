...
| TC-B05  | CVC = 2 и 4 цифры                                           | CVC                                  | Ввесть 2 цифры а затем 4 цифры                                       | Отклонянется согласно правилам шлюза|
...
| TC-V04  | Срок действия в прошлом                                     | MM/YY                 | 12/23                                 | «Карта просрочена» |
| TC-V05  | Спецсимволы в имени держателя                               | Cardholder Name       | IVAN@#$ PETROV                        | Блокировка или ошибка шлюза |
| TC-V06  | Имя на кириллице (если не поддерживается)                   | Cardholder Name       | ИВАН ИВАНОВ                           | Ошибка шлюза или клиентская валидация |
...
| TC-I08  | Логирование                                                | PCI DSS                       | Проверить логи после оплаты                         | Номер карты замаскирован (**** **** **** 1234) |
